...
import net.elzbietkadev.elzbietkamod.worldgen.ModBiomeModifiers;
import net.elzbietkadev.elzbietkamod.worldgen.ModConfiguredFeatures;
...
public class ModWorldGenProvider extends DatapackBuiltinEntriesProvider {
    ...
    public ModWorldGenProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Set.of(ElzbietkaMod.MOD_ID));
    }
}