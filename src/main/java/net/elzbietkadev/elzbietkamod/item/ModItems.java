...
public class ModItems {
    ...
    public static final RegistryObject<Item> ELZBIETKA_SPAWN_EGG = ITEMS.register("elzbietka_spawn_egg",
            () -> new ForgeSpawnEggItem(ModEntities.ELZBIETKA, 0x7f3300, 0xff0000, new Item.Properties()));
